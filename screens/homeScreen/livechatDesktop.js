...
function openChatWindowDesktop(ele){
    ...
    if (isChatOpen == true && currentChatViewing==chatid){ //close
        ...
        setTimeout(() => {
            ...
            chatHTML = `<div class='row'><h1>`+nameOfFriend+`</h1><hr></div><div id='chatchat' class='scrollbar' style='height:700px;overflow: scroll;overflow-x: hidden'>`
                ...
                for(mes of currentChatData){
                    ...
                    if (sender == window.sessionStorage.userName){
                        chatMsgHtml = `<div class='row my-1'>
                                            <div class='col-7'></div>
                                            <div class='col-5'>
                                                <div style='background-color:#915d3c;color:white;font-size: 13px;' class='py-2 px-2 rounded-2'>
                                                    <h5>`+message+`</h5>
                                                </div>
                                            </div>
                                        </div>`
                        ...
                        chatMsgHtml = `<div class='row my-1'>
                                            <div class='col-5 '>
                                                <div style='background-color:#d98550;color:white;font-size: 13px;' class='py-2 px-2 rounded-2'>
                                                    <h5>`+message+`</h5>
                                                </div>
                                            </div>
                                            <div class='col-7'>
        ...
        .then((response) => {
            ...
            for (let i = 1; i < response.length; i++) {
                ...
                if (friendName != username){
                    ...
                    // console.log(chatId)
                    newHtml = `<div id='chatID-`+chatId+`-`+friendName+`' class='row hover-color2' style='border-bottom: 2px solid #f5d2bc' onclick='openChatWindowDesktop(this.id)'>
                                    <div class='col-3'>
